                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="posti">
                            ...
                            <li>Parco Giardino Sigurtà - <?php echo e(trans('messages.distanza')); ?>: 10 km</li>
                            <li>Parco Natura Viva (zoo e safari) - <?php echo e(trans('messages.distanza')); ?>: 10 km</li>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="posti">
                            ...
                            <li>Bardolino - <?php echo e(trans('messages.distanza')); ?>: 16 km</li>
                            <li>Garda - <?php echo e(trans('messages.distanza')); ?>: 20 km</li>
                            <li>Borghetto - <?php echo e(trans('messages.distanza')); ?>: 11 km</li>
                            <li>Desenzano del Garda - <?php echo e(trans('messages.distanza')); ?>: 18 km</li>
                            <li>Verona - <?php echo e(trans('messages.distanza')); ?>: 22 km</li>
                            <li>Mantova - <?php echo e(trans('messages.distanza')); ?>: 38 km</li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mia\ProgrammazioneWeb\Human-Macchine-Interaction\Riprogettazione Zenzero Holydays\resources\views/pages/luoghiDiInteresse.blade.php ENDPATH**/ ?>