        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0"> 
            ...
            <?php if((session('logged')) && (session('role') == 'registered_user')): ?>
              <li class="nav-item">
                <a class="nav-link  <?php echo $__env->yieldContent('active_prenotazioni'); ?> me-2" href="<?php echo e(route('prenotazioni.index')); ?>"><?php echo e(trans('button.prenotazioni')); ?></a>
              </li>
...
</html><?php /**PATH C:\mia\ProgrammazioneWeb\elaborato\ZenzeroHolidays\resources\views/layouts/master.blade.php ENDPATH**/ ?>