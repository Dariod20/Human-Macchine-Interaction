    ...
    <div class="container-fluid px-lg-4 mt-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <?php elseif(isset($arrivo)): ?>
                    <form class="form-horizontal" name="prenotazioni" method="post" action="<?php echo e(route('prenotazioni.store')); ?>">
                <?php else: ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\mia\ProgrammazioneWeb\elaborato\ZenzeroHolidays\resources\views/adminPrenotazioni/editPrenotazione.blade.php ENDPATH**/ ?>