    ...
    <div class="container-fluid px-lg-4 mt-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="form-group row mb-3">
                        <a class="btn btn-secondary w-100" href="<?php echo e(route('prenotazioniAdmin.index')); ?>"><i class="bi bi-box-arrow-left"></i> <?php echo e(trans('messages.annulla')); ?></a>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Human-Macchine-Interaction\Riprogettazione Zenzero Holydays\resources\views/adminPrenotazioni/editPrenotazione.blade.php ENDPATH**/ ?>