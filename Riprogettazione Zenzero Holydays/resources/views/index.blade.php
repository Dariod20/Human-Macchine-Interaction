...
@section('corpo')
      ...
      <div class="container-fluid" id="caroselloHome">
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel">
         ...
         <div class="position-absolute top-50 start-50 translate-middle">
          <a class="btn btn-prenota btn-lg" href="{{ route('calendario') }}">{{ trans('button.book') }}</a>
        </div>
      </div>
    </section>
    ...
    <section id="titoloHome">
      <div class="container text-center" id="titolo"> <!--Inserire gli elementi in un container me li rende responsive e crea i margini-->
          ...
          <h1>{{ trans('messages.titoloHome') }}</h1>
          <p class="lead">
            {{ trans('messages.testoHome') }}
          </p>
      
          <a href="{{ route('contatti') }}" class="btn btn-custom">{{ trans('button.contact') }}</a>
      </div>
    </section>
            ...
            <div class="row ">
                <div class="col-sm ">
                    <div class="card card-custom mx-auto border-0 my-2">
                        ...
                        <div class="card-body">
                            <p class="card-text lead">{{ trans('messages.card1') }}</p>
                            <a href="{{ route('casaVacanze') }}" class="btn btn-custom">{{ trans('button.casa') }}</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm">
                    <div class="card card-custom mx-auto border-0 my-2">
                        ...
                        <div class="card-body">
                            <p class="card-text lead">{{ trans('messages.card2') }}</p>
                            <a href="{{ route('luoghiDiInteresse') }}" class="btn btn-custom">{{ trans('button.luoghi') }}</a>
                        </div>
                    </div>
                </div>
            </div>
