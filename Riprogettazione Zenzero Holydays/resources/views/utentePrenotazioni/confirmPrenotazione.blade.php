  ...
  $(document).ready(function(){
    ...
    function validateStep1() {
        ...
        if (arrivo && partenza && arrivo >= partenza) {
            document.getElementById('invalid-arrivo').textContent = "{{ trans('errors.partenzaErr') }}";
            $("#daterange").focus();
            error = true;
        }
    ...
    function validateStep3() {
        ...
        if (telefono.trim() === "") {
            ...
            document.getElementById('invalid-telefono').textContent = "{{ trans('errors.telErrLength') }}";
            error = true;
            $("input[name='telefono']").focus();
        } else {
                  ...
                  $.ajax({
                    ...
                    success: function (response) {
                      if (!response.available) {
                        error = true;
                        var message ="{{ trans('errors.dateChiuse') }}";
              ...
              <div class="mb-3">
                ...
                <div class="input-group date">
                  <select class="form-control" id="orarioArrivo" name="orarioArrivo">
                    <option value="" disabled selected>{{ trans('messages.selezionaOrario') }}</option>
