            ...
            <div class="row">
                <div>
                    <ul class="nav nav-tabs mb-3 justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#login-tab">{{ trans('button.login') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#register-tab">{{ trans('button.registrati') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="login-tab">
                        <form id="login-form" action="{{ route('user.login') }}" method="post">
                            ...
                            <div class="form-group text-center mb-3">
                                <label for="login-submit" class="btn btn-primary w-100"><i class="bi bi-door-open"></i> {{ trans('button.login') }} </label>
                    ...
                    <div class="tab-pane" id="register-tab">
                        <form id="register-form" action="{{ route('user.register') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                <input type="password" name="registration-password" class="form-control" placeholder="Inserisci password..."/>
                            </div>
                            ...
                            <div class="form-group text-center mb-3">
                                <label for="register-submit" class="btn btn-primary w-100"><i class="bi bi-person-plus"></i> {{ trans('button.registrati') }}</label>
